...
| 1 | Chord Library: chord data set, data-driven fretboard renderer, audio pluck synth, browse + "mark learned" | ⬜ next |
| 2 | Chord Switching Trainer: metronome engine, 2-chord drills, switch-speed tracking per pair | ⬜ |
